...
prob2_naive() {
    echo "Running commands for prob2_naive"
    /usr/bin/time -l go run prob2_naive.go ncbi_dataset_T2T/ncbi_dataset/data/GCA_009914755.4/GCA_009914755.4_T2T-CHM13v2.0_genomic.fna
    /usr/bin/time -l go run prob2_naive.go ncbi_dataset_GRCh38/ncbi_dataset/data/GCA_000001405.29/GCA_000001405.29_GRCh38.p14_genomic.fna
}
